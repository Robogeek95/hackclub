...
**Gitpod** is an open source platform for automated and ready-to-code development environments that blends into your existing workflow. It enables developers start instant and fresh development environments directly from your browser.

- First create a new repository on github, we would use this repository to initialize a gitpod workspace

- Go to https://www.gitpod.io/#get-started, paste your repository url and click start workspace.

![Start gitpod workspace](https://cloud-ie7jrwaqf.vercel.app/0screenshot_from_2020-12-18_11-08-20.png)

You have successfully created an online development environment with terminal access.
...
create a new directory called ghost and cd into ghost
...
Now ghost is all set up and running

### Setup Next.js react application

checkout into the base dir
...
our posts.js file should look like this:
